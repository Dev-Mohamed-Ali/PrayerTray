...
internal static class Strings
{
    ...
    static readonly Dictionary<string, string> _en = new()
    {
        ...
        ["update.availableBody"] = "PrayerTray {0} is available. Download and install it?",
        ...
        ["chk.pingTcp"] = "TCP ping (port 443, works with per-app proxy rules)",
        ["label.netInterface"] = "Network interface",
        ["iface.all"] = "All interfaces",
        ["iface.missing"] = "(disconnected adapter)",
        ["chk.trackUsage"] = "Track data usage",
        ["chk.showUsage"] = "Show today's data total in the pill",
        ["menu.dataUsage"] = "Data usage…",
        ["usage.title"] = "Data usage",
        ["usage.today"] = "Today: ↓ {0}   ↑ {1}",
        ["usage.date"] = "Date",
        ["usage.down"] = "Down",
        ["usage.up"] = "Up",
        ["usage.total"] = "Total",
        ["btn.resetUsage"] = "Reset",
        ["btn.close"] = "Close",
        ["usage.resetConfirm"] = "Clear all recorded data usage?",
        ...
        ["btn.exportCfg"] = "Export…",
        ["btn.importCfg"] = "Import…",
        ["msg.importError"] = "Couldn't read that settings file.",
        ["msg.exportError"] = "Couldn't write the settings file.",
        ["update.downloading"] = "Downloading update…",
        ["update.restartAsk"] = "Update downloaded. Restart PrayerTray now?",
        ["update.failed"] = "Couldn't install the update",
        ["label.iqamah"] = "Iqamah",
        ["label.iqamahTune"] = "Iqamah after azan (minutes, 0 = off)",
        ["fast.today"] = "Fasting today: {0}",
        ["fast.tomorrow"] = "Fasting tomorrow: {0}",
    ...
    static readonly Dictionary<string, string> _ar = new()
    {
        ...
        ["update.availableBody"] = "يتوفر PrayerTray {0}. تنزيله وتثبيته؟",
        ...
        ["chk.pingTcp"] = "فحص TCP (منفذ 443، يعمل مع قواعد البروكسي لكل تطبيق)",
        ["label.netInterface"] = "واجهة الشبكة",
        ["iface.all"] = "كل الواجهات",
        ["iface.missing"] = "(محول غير متصل)",
        ["chk.trackUsage"] = "تتبع استهلاك البيانات",
        ["chk.showUsage"] = "إظهار إجمالي اليوم في الشريط",
        ["menu.dataUsage"] = "استهلاك البيانات…",
        ["usage.title"] = "استهلاك البيانات",
        ["usage.today"] = "اليوم: ↓ {0}   ↑ {1}",
        ["usage.date"] = "التاريخ",
        ["usage.down"] = "تنزيل",
        ["usage.up"] = "رفع",
        ["usage.total"] = "الإجمالي",
        ["btn.resetUsage"] = "تصفير",
        ["btn.close"] = "إغلاق",
        ["usage.resetConfirm"] = "مسح كل بيانات الاستهلاك المسجلة؟",
        ["btn.exportCfg"] = "تصدير…",
        ["btn.importCfg"] = "استيراد…",
        ["msg.importError"] = "تعذر قراءة ملف الإعدادات.",
        ["msg.exportError"] = "تعذر حفظ ملف الإعدادات.",
        ["update.downloading"] = "جارٍ تنزيل التحديث…",
        ["update.restartAsk"] = "تم تنزيل التحديث. إعادة تشغيل PrayerTray الآن؟",
        ["update.failed"] = "تعذر تثبيت التحديث",
        ["label.iqamah"] = "الإقامة",
        ["label.iqamahTune"] = "الإقامة بعد الأذان (دقائق، 0 = إيقاف)",
        ["fast.today"] = "صيام اليوم: {0}",
        ["fast.tomorrow"] = "صيام غدًا: {0}",
    ...
    static readonly Dictionary<string, string> _fr = new()
    {
        ...
        ["update.availableBody"] = "PrayerTray {0} est disponible. Le télécharger et l'installer ?",
        ...
        ["chk.pingTcp"] = "Ping TCP (port 443, compatible règles proxy par application)",
        ["label.netInterface"] = "Interface réseau",
        ["iface.all"] = "Toutes les interfaces",
        ["iface.missing"] = "(carte déconnectée)",
        ["chk.trackUsage"] = "Suivre la consommation de données",
        ["chk.showUsage"] = "Afficher le total du jour dans la pastille",
        ["menu.dataUsage"] = "Consommation de données…",
        ["usage.title"] = "Consommation de données",
        ["usage.today"] = "Aujourd'hui : ↓ {0}   ↑ {1}",
        ["usage.date"] = "Date",
        ["usage.down"] = "Reçu",
        ["usage.up"] = "Envoyé",
        ["usage.total"] = "Total",
        ["btn.resetUsage"] = "Réinitialiser",
        ["btn.close"] = "Fermer",
        ["usage.resetConfirm"] = "Effacer toutes les données enregistrées ?",
        ["btn.exportCfg"] = "Exporter…",
        ["btn.importCfg"] = "Importer…",
        ["msg.importError"] = "Impossible de lire ce fichier de paramètres.",
        ["msg.exportError"] = "Impossible d'écrire le fichier de paramètres.",
        ["update.downloading"] = "Téléchargement de la mise à jour…",
        ["update.restartAsk"] = "Mise à jour téléchargée. Redémarrer PrayerTray maintenant ?",
        ["update.failed"] = "Impossible d'installer la mise à jour",
        ["label.iqamah"] = "Iqama",
        ["label.iqamahTune"] = "Iqama après l'adhan (minutes, 0 = désactivé)",
        ["fast.today"] = "Jeûne aujourd'hui : {0}",
        ["fast.tomorrow"] = "Jeûne demain : {0}",
    ...
    static readonly Dictionary<string, string> _tr = new()
    {
        ...
        ["update.availableBody"] = "PrayerTray {0} mevcut. İndirilip kurulsun mu?",
        ...
        ["chk.pingTcp"] = "TCP ping (443 portu, uygulama bazlı proxy kurallarıyla çalışır)",
        ["label.netInterface"] = "Ağ arabirimi",
        ["iface.all"] = "Tüm arabirimler",
        ["iface.missing"] = "(bağlı olmayan bağdaştırıcı)",
        ["chk.trackUsage"] = "Veri kullanımını izle",
        ["chk.showUsage"] = "Bugünün toplamını çubukta göster",
        ["menu.dataUsage"] = "Veri kullanımı…",
        ["usage.title"] = "Veri kullanımı",
        ["usage.today"] = "Bugün: ↓ {0}   ↑ {1}",
        ["usage.date"] = "Tarih",
        ["usage.down"] = "İndirme",
        ["usage.up"] = "Yükleme",
        ["usage.total"] = "Toplam",
        ["btn.resetUsage"] = "Sıfırla",
        ["btn.close"] = "Kapat",
        ["usage.resetConfirm"] = "Kayıtlı tüm veri kullanımı silinsin mi?",
        ["btn.exportCfg"] = "Dışa aktar…",
        ["btn.importCfg"] = "İçe aktar…",
        ["msg.importError"] = "Ayar dosyası okunamadı.",
        ["msg.exportError"] = "Ayar dosyası yazılamadı.",
        ["update.downloading"] = "Güncelleme indiriliyor…",
        ["update.restartAsk"] = "Güncelleme indirildi. PrayerTray şimdi yeniden başlatılsın mı?",
        ["update.failed"] = "Güncelleme kurulamadı",
        ["label.iqamah"] = "Kamet",
        ["label.iqamahTune"] = "Ezandan sonra kamet (dakika, 0 = kapalı)",
        ["fast.today"] = "Bugün oruç: {0}",
        ["fast.tomorrow"] = "Yarın oruç: {0}",
    ...
    static readonly Dictionary<string, string> _ur = new()
    {
        ...
        ["update.availableBody"] = "PrayerTray {0} دستیاب ہے۔ ڈاؤن لوڈ اور انسٹال کریں؟",
        ...
        ["chk.pingTcp"] = "TCP پنگ (پورٹ 443، فی ایپ پراکسی قواعد کے ساتھ کام کرتا ہے)",
        ["label.netInterface"] = "نیٹ ورک انٹرفیس",
        ["iface.all"] = "تمام انٹرفیس",
        ["iface.missing"] = "(منقطع اڈاپٹر)",
        ["chk.trackUsage"] = "ڈیٹا استعمال ٹریک کریں",
        ["chk.showUsage"] = "آج کا کل ڈیٹا پٹی میں دکھائیں",
        ["menu.dataUsage"] = "ڈیٹا استعمال…",
        ["usage.title"] = "ڈیٹا استعمال",
        ["usage.today"] = "آج: ↓ {0}   ↑ {1}",
        ["usage.date"] = "تاریخ",
        ["usage.down"] = "ڈاؤن لوڈ",
        ["usage.up"] = "اپ لوڈ",
        ["usage.total"] = "کل",
        ["btn.resetUsage"] = "ری سیٹ",
        ["btn.close"] = "بند کریں",
        ["usage.resetConfirm"] = "تمام ریکارڈ شدہ ڈیٹا استعمال صاف کریں؟",
        ["btn.exportCfg"] = "ایکسپورٹ…",
        ["btn.importCfg"] = "امپورٹ…",
        ["msg.importError"] = "سیٹنگز فائل پڑھی نہیں جا سکی۔",
        ["msg.exportError"] = "سیٹنگز فائل لکھی نہیں جا سکی۔",
        ["update.downloading"] = "اپڈیٹ ڈاؤن لوڈ ہو رہی ہے…",
        ["update.restartAsk"] = "اپڈیٹ ڈاؤن لوڈ ہو گئی۔ PrayerTray ابھی دوبارہ شروع کریں؟",
        ["update.failed"] = "اپڈیٹ انسٹال نہیں ہو سکی",
        ["label.iqamah"] = "اقامت",
        ["label.iqamahTune"] = "اذان کے بعد اقامت (منٹ، 0 = بند)",
        ["fast.today"] = "آج روزہ: {0}",
        ["fast.tomorrow"] = "کل روزہ: {0}",
    ...
    static readonly Dictionary<string, string> _id = new()
    {
        ...
        ["update.availableBody"] = "PrayerTray {0} tersedia. Unduh dan pasang?",
        ...
        ["chk.pingTcp"] = "Ping TCP (port 443, cocok dengan aturan proxy per aplikasi)",
        ["label.netInterface"] = "Antarmuka jaringan",
        ["iface.all"] = "Semua antarmuka",
        ["iface.missing"] = "(adaptor terputus)",
        ["chk.trackUsage"] = "Lacak penggunaan data",
        ["chk.showUsage"] = "Tampilkan total hari ini di pil",
        ["menu.dataUsage"] = "Penggunaan data…",
        ["usage.title"] = "Penggunaan data",
        ["usage.today"] = "Hari ini: ↓ {0}   ↑ {1}",
        ["usage.date"] = "Tanggal",
        ["usage.down"] = "Unduh",
        ["usage.up"] = "Unggah",
        ["usage.total"] = "Total",
        ["btn.resetUsage"] = "Atur ulang",
        ["btn.close"] = "Tutup",
        ["usage.resetConfirm"] = "Hapus semua catatan penggunaan data?",
        ["btn.exportCfg"] = "Ekspor…",
        ["btn.importCfg"] = "Impor…",
        ["msg.importError"] = "Tidak dapat membaca berkas pengaturan.",
        ["msg.exportError"] = "Tidak dapat menulis berkas pengaturan.",
        ["update.downloading"] = "Mengunduh pembaruan…",
        ["update.restartAsk"] = "Pembaruan terunduh. Mulai ulang PrayerTray sekarang?",
        ["update.failed"] = "Tidak dapat memasang pembaruan",
        ["label.iqamah"] = "Iqamah",
        ["label.iqamahTune"] = "Iqamah setelah azan (menit, 0 = nonaktif)",
        ["fast.today"] = "Puasa hari ini: {0}",
        ["fast.tomorrow"] = "Puasa besok: {0}",
