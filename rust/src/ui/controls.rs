...
use windows::Win32::Graphics::Gdi::{
    CreateFontW, CreateSolidBrush, DeleteObject, DrawTextW, EnumFontFamiliesExW, FillRect,
    GetDC, ReleaseDC, SelectObject, SetBkMode, SetTextColor, CLIP_DEFAULT_PRECIS,
    DEFAULT_CHARSET, DEFAULT_QUALITY, DT_CENTER, DT_END_ELLIPSIS, DT_LEFT, DT_RIGHT,
    DT_SINGLELINE, DT_VCENTER, FF_DONTCARE, FW_BOLD, FW_NORMAL, HBRUSH,
    HDC, HFONT, LOGFONTW, OUT_DEFAULT_PRECIS, TEXTMETRICW, TRANSPARENT,
};
use windows::Win32::UI::Controls::{SetWindowTheme, DRAWITEMSTRUCT, ODS_DISABLED};
use windows::Win32::UI::Input::KeyboardAndMouse::EnableWindow;
use windows::Win32::UI::WindowsAndMessaging::{
    CreateWindowExW, GetWindowTextLengthW, GetWindowTextW, SendMessageW, SetWindowTextW,
    BM_GETCHECK, BM_SETCHECK, BS_AUTOCHECKBOX, BS_OWNERDRAW, CBS_DROPDOWNLIST, CBS_HASSTRINGS,
    CB_ADDSTRING, CB_GETCURSEL, CB_SETCURSEL, ES_AUTOHSCROLL, HMENU,
    WINDOW_EX_STYLE, WINDOW_STYLE, WM_SETFONT, WS_BORDER, WS_CHILD, WS_TABSTOP, WS_VISIBLE,
    WS_VSCROLL,
};
...
pub fn combo(parent: HWND, x: i32, y: i32, w: i32, h: i32, id: i32) -> HWND {
    let c = create(
        ...
        w!("COMBOBOX"),
        "",
        WS_TABSTOP.0 | WS_VSCROLL.0 | (CBS_DROPDOWNLIST | CBS_HASSTRINGS) as u32,
        x,
        y,
        w,
        h,
...
/// Un-themed so WM_CTLCOLORSTATIC text/background colors apply (classic glyph).
...
pub fn set_checked(h: HWND, v: bool) {
    unsafe {
        SendMessageW(h, BM_SETCHECK, Some(WPARAM(v as usize)), Some(LPARAM(0)));
    }
}
