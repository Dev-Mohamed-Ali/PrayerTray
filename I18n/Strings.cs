...
internal static class Strings
{
    ...
    static readonly Dictionary<string, string> _en = new()
    {
        ...
        ["update.availableBody"] = "PrayerTray {0} is available. Open the download page?",
        ["update.none"] = "You're up to date ({0})",
        ["update.error"] = "Couldn't check for updates",
        ["msg.startupError"] = "Couldn't change the startup setting",
        ["menu.exit"] = "Exit",
        ["tray.now"] = "Now:",
        ["tray.next"] = "Next:",
        ["tray.in"] = "in",
        ...
        ["chk.ping"] = "Show ping (latency)",
        ["label.pingHost"] = "Ping host",
        ["chk.compactMeters"] = "Compact meter width (2-digit values)",
    ...
    static readonly Dictionary<string, string> _ar = new()
    {
        ...
        ["update.availableTitle"] = "تحديث متوفر",
        ["update.availableBody"] = "يتوفر PrayerTray {0}. فتح صفحة التنزيل؟",
        ["update.none"] = "أنت على أحدث إصدار ({0})",
        ["update.error"] = "تعذر التحقق من التحديثات",
        ["msg.startupError"] = "تعذر تغيير إعداد بدء التشغيل",
        ["menu.exit"] = "خروج",
        ["tray.now"] = "الآن:",
        ["tray.next"] = "التالي:",
        ["tray.in"] = "خلال",
        ...
        ["chk.ping"] = "إظهار زمن الاستجابة (Ping)",
        ["label.pingHost"] = "مضيف Ping",
        ["chk.compactMeters"] = "عرض مضغوط للمقاييس (قيم من رقمين)",
    ...
    static readonly Dictionary<string, string> _fr = new()
    {
        ...
        ["update.availableBody"] = "PrayerTray {0} est disponible. Ouvrir la page de téléchargement ?",
        ["update.none"] = "Vous êtes à jour ({0})",
        ["update.error"] = "Impossible de vérifier les mises à jour",
        ["msg.startupError"] = "Impossible de modifier le démarrage automatique",
        ["menu.exit"] = "Quitter",
        ["tray.now"] = "Maintenant :",
        ["tray.next"] = "Suivant :",
        ["tray.in"] = "dans",
        ...
        ["chk.ping"] = "Afficher le ping (latence)",
        ["label.pingHost"] = "Hôte ping",
        ["chk.compactMeters"] = "Largeur compacte des compteurs (valeurs à 2 chiffres)",
    ...
    static readonly Dictionary<string, string> _tr = new()
    {
        ...
        ["update.availableBody"] = "PrayerTray {0} mevcut. İndirme sayfası açılsın mı?",
        ["update.none"] = "Güncelsiniz ({0})",
        ["update.error"] = "Güncellemeler denetlenemedi",
        ["msg.startupError"] = "Başlangıç ayarı değiştirilemedi",
        ["menu.exit"] = "Çıkış",
        ["tray.now"] = "Şimdi:",
        ["tray.next"] = "Sıradaki:",
        ["tray.in"] = "kalan",
        ...
        ["chk.ping"] = "Ping (gecikme) göster",
        ["label.pingHost"] = "Ping sunucusu",
        ["chk.compactMeters"] = "Dar gösterge genişliği (2 basamaklı değerler)",
    ...
    static readonly Dictionary<string, string> _ur = new()
    {
        ...
        ["menu.checkUpdates"] = "اپڈیٹس چیک کریں",
        ["update.availableTitle"] = "اپڈیٹ دستیاب ہے",
        ["update.availableBody"] = "PrayerTray {0} دستیاب ہے۔ ڈاؤن لوڈ صفحہ کھولیں؟",
        ["update.none"] = "آپ تازہ ترین ورژن پر ہیں ({0})",
        ["update.error"] = "اپڈیٹس چیک نہیں ہو سکیں",
        ["msg.startupError"] = "اسٹارٹ اپ کی ترتیب تبدیل نہیں ہو سکی",
        ["menu.exit"] = "خروج",
        ["tray.now"] = "ابھی:",
        ["tray.next"] = "اگلی:",
        ["tray.in"] = "میں",
        ...
        ["chk.ping"] = "پنگ (تاخیر) دکھائیں",
        ["label.pingHost"] = "پنگ ہوسٹ",
        ["chk.compactMeters"] = "میٹر کی چوڑائی مختصر (دو ہندسی اقدار)",
    ...
    static readonly Dictionary<string, string> _id = new()
    {
        ...
        ["menu.checkUpdates"] = "Periksa pembaruan",
        ["update.availableTitle"] = "Pembaruan tersedia",
        ["update.availableBody"] = "PrayerTray {0} tersedia. Buka halaman unduhan?",
        ["update.none"] = "Anda sudah menggunakan versi terbaru ({0})",
        ["update.error"] = "Tidak dapat memeriksa pembaruan",
        ["msg.startupError"] = "Tidak dapat mengubah pengaturan startup",
        ["menu.exit"] = "Keluar",
        ["tray.now"] = "Sekarang:",
        ...
        ["chk.ping"] = "Tampilkan ping (latensi)",
        ["label.pingHost"] = "Host ping",
        ["chk.compactMeters"] = "Lebar meter ringkas (nilai 2 digit)",
